...
- `doc-env scan` — scan project for env variable issues with text or JSON output
- `doc-env check` — CI-friendly command that exits 1 on missing variables
- `doc-env generate` — auto-generate or update `.env.example` from scan results
