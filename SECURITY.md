...
If you discover a security vulnerability in env-doctor:

1. **Email:** Open a GitHub Security Advisory (preferred) at
   [github.com/env-doctor/env-doctor/security/advisories/new](https://github.com/env-doctor/env-doctor/security/advisories/new)
...
env-doctor is a **local-only CLI tool** with these security properties:

- **No network access** — env-doctor never makes HTTP requests or phone-home calls
